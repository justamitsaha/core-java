...
public class ETryWithResource {
    ...
    //try-with-resources statement to automatically close all resources opened in a try clause.Behind the scenes, the compiler replaces a try-with-resources block with a try and finally block. We refer to this â€œhiddenâ€� finally block as an implicit finally block since it is created and used by the compiler automatically.
