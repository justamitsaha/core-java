...
public class G_SchedulingTask {
	...
	public static void main(String[] args) {
		...
		Callable<String> task2 = (() -> {System.out.println("This is callable task"); return "This is callable task";});
		...
		try {
			//The duration of the get should be such that the thread is execution is complete otherwise it will throw exception
			System.out.println(s.get(10, TimeUnit.SECONDS));
		} catch (InterruptedException | ExecutionException | TimeoutException e) {
			e.printStackTrace();
		}
		
		Runnable task3 = (() -> {System.out.println("This is a runnable task3");});
